...
var express = require('express'),
    ...
    port = process.env.PORT || 3000; // Handlebars
...
app.use('/assets', express["static"]('public')); // Body parser permet de parser les data d'une page à l'autre en passant par les controllers, ... 
...
app.use('/', ROUTER); // app.use((req, res) => {
//     res.render('err404')
// })
